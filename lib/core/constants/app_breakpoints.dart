...
class AppSizing {
  ...
  /// Altura de botón compacto: 32px — acciones dentro de tiles (ChatTile)
  ...
  // Avatares
  /// Avatar extra pequeño: 20px — tiles compactos como PrioridadTileHome
  static const double avatarXss = 20;
  ...
  static const double avatarRadiusXss = avatarXss / 2; // 16
  static const double avatarRadiusXs = avatarXs / 2;
  ...
  /// Botón de acción extra compacto: 26px — WA/teléfono en PrioridadTileHome versión densa
  static const double miniActionButtonSm = 26.0;
