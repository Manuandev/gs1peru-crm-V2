// lib/features/auth/presentation/widgets/splash/splash_portrait.dart
...
class _SplashPortraitState extends State<SplashPortrait>
  ...
  // ── Controladores ──────────────────────────────────────────────────────────
  late final AnimationController _seqController;   // intro (una sola vez)
  late final AnimationController _ringController;  // rotación de anillos (loop)
  late final AnimationController _pulseController; // pulso suave del logo (loop)
        ...
        return Center(
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    // Logo: fade + escala de entrada, luego pulso suave
                    Opacity(
              ...
              // ── Nombre de la app: fade + slide desde abajo ───────────────
              Opacity(
