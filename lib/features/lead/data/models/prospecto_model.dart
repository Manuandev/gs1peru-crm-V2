...
class ProspectoModel extends Prospecto {
  ...
  factory ProspectoModel.fromRawString(String raw) {
  ...
  static List<ProspectoModel> parseList(String rawResponse) {
    return rawResponse
        .split(AppConstants.sepRegistros)
        .where((r) => r.trim().isNotEmpty)
        .map((r) => ProspectoModel.fromRawString(r))
        .toList();
  }
}
