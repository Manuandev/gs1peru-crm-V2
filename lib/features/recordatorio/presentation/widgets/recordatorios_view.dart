...
import 'package:app_crm/features/recordatorio/presentation/bloc/recordatorios_bloc.dart';
...
import 'package:app_crm/features/recordatorio/presentation/widgets/recordatorios_landscape.dart';
import 'package:app_crm/features/recordatorio/presentation/widgets/recordatorios_portrait.dart';
    ...
    return BasePage(
      ...
      appBarTrailingButtons: [
        IconButton(
          ...
          onPressed: () {
            context.read<RecordatoriosBloc>().add(
              RecordatoriosRefreshRequested(),
            );
          },
        ),
      ],
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () => context.read<RecordatoriosBloc>().add(
                      RecordatoriosRefreshRequested(),
                    ),
