...
class SolicitudFormCubit extends Cubit<SolicitudFormState> {
  ...
  /// 'Tipo de persona' ya no se elige (se quitó el toggle Jurídica/Natural,
  /// 2026-09-18): es Jurídica si "Información comercial" tiene RUC, Natural
  /// si no. Se recalcula en cada sync del paso 1.
  void guardarSolicitante(DatosSolicitante datos) => emit(
    state.copyWith(
      solicitante: datos,
      tipoPersona: datos.ruc.trim().isNotEmpty ? 'juridica' : 'natural',
    ),
  );
